...
if (isset($_GET['hapus'])) {
    ...
    // Ambil path file foto dan audio sebelum dihapus dari database
    $query_file = "SELECT foto_path, audio_path FROM tb_seni_budaya WHERE id = '$id_hapus'";
    $result_file = mysqli_query($koneksi, $query_file);
    $data_file = mysqli_fetch_assoc($result_file);

    $query_hapus = "DELETE FROM tb_seni_budaya WHERE id = '$id_hapus'";
    ...
    if (mysqli_query($koneksi, $query_hapus)) {
        ...
        echo "<script>alert('Data beserta file foto & audio berhasil dihapus!'); window.location='seni_kelola.php';</script>";
    } else {
        echo "<script>alert('Gagal menghapus data.');</script>";
    }
}

$query = "SELECT * FROM tb_seni_budaya ORDER BY id ASC";
...
<head>
    ...
    <title>Manajemen Seni & Budaya - Admin</title>
    ...
    <style>
        ...
        * {
        ...
        .badge-kategori { background: rgba(0, 123, 255, 0.1); color: #007bff; }
...
<div class="main-content">
    <div class="page-header">
        <h2>Manajemen Seni & Budaya</h2>
        <a href="seni_tambah.php" class="btn btn-add">＋ Tambah Data</a>
    </div>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    <td><?= $no++; ?></td>
                    <td>
                        <span class="badge badge-kategori"><?= strtoupper($row['kategori']); ?></span>
                    </td>
                    ...
                    <td>
                        <a href="seni_edit.php?id=<?= $row['id']; ?>" class="btn btn-edit">✎ Edit</a>
                        <a href="seni_kelola.php?hapus=<?= $row['id']; ?>" class="btn btn-delete" onclick="return confirm('Yakin ingin menghapus kesenian ini? Foto dan Audio juga akan ikut terhapus.');">🗑 Hapus</a>
                    </td>
                </tr>
                <?php } ?>
                ...
                <tr>
                    <td colspan="6" style="text-align: center; padding: 30px; color: var(--text-muted);">
                        Belum ada data seni & budaya. Silakan tambahkan data baru.
                    </td>
                </tr>
                <?php endif; ?>
            </tbody>
