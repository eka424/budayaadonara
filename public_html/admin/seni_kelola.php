...
if (isset($_GET['hapus'])) {
    ...
    if (mysqli_query($koneksi, $query_hapus)) {
        ...
        echo "<script>alert('Data berhasil dihapus!'); window.location='seni_kelola.php';</script>";
    } else {
...
<div class="main-content">
    ...
    <div class="table-container">
        <table>
            <thead>
                <tr>
                    <th>No</th><th>Kategori</th><th>Judul</th><th>Media</th><th>Aksi</th>
                </tr>
            </thead>
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a href="seni_kelola.php?hapus=<?= $row['id']; ?>" class="btn btn-delete" onclick="return confirm('Yakin hapus?');">Hapus</a>
                    </td>
                </tr>
                <?php endwhile; ?>
            </tbody>
