...
// Mengambil data seni dan budaya
$query_seni = "SELECT * FROM tb_seni_budaya ORDER BY id ASC";
$result_seni = mysqli_query($koneksi, $query_seni);
?>
<!DOCTYPE html>
<html lang="id">
<head>
    ...
    <title>Seni & Budaya - Budaya Adonara</title>
    ...
    <style>
        ...
        /* Efek Background Dinding Galeri */
        .bg-overlay {
            position: fixed;
            top: 0; left: 0; 
            width: 100%; height: 100vh;
            background-image: url('assets/uploads/foto/bg-seni.jpg');
        ...
        .gallery-row {
            ...
            gap: 40px;
            margin-bottom: 80px;
            scroll-margin-top: 120px; /* Jarak untuk header saat di-scroll */
        }
    ...
    <main class="main-content">
        <nav class="top-nav">
            ...
            <div class="nav-links" id="nav-links">
                ...
                <div class="dropdown">
                    <a href="seni_budaya.php" class="active">Seni & Budaya ▾</a>
                    <div class="dropdown-content">
                        <!-- LINK MENU SENI & BUDAYA SUDAH DISESUAIKAN DENGAN DATABASE -->
        ...
        <section class="about-section animate-on-scroll" style="border-top: none; padding-top: 60px; padding-bottom: 40px;">
            ...
            <p style="text-align: center; color: var(--text-muted); margin-top: -30px; margin-bottom: 50px; font-size: 14px; letter-spacing: 1px;">Eksibisi Mahakarya dan Kreativitas Leluhur</p>
        </section>

        <div class="container" style="margin-top: 0; padding: 0 15px;">
            <?php while($row = mysqli_fetch_assoc($result_seni)): ?>
                <?php 
                ...
                <div class="gallery-row animate-on-scroll" id="<?= $anchor_id; ?>">
                    <div class="artwork-display">
                        <?php $foto = !empty($row['foto_path']) ? $row['foto_path'] : 'assets/uploads/foto/default-seni.jpg'; ?>
                        <img src="<?= $foto; ?>" alt="<?= $row['judul']; ?>" class="canvas-frame">
                    </div>
                    <div class="museum-plaque">
                        <span class="plaque-category"><?= $row['kategori']; ?></span>
                        <h3><?= $row['judul']; ?></h3>
                        <p><?= nl2br($row['isi']); ?></p>
                        <?php if(!empty($row['audio_path'])): ?>
                            <div class="audio-guide">
                                <strong>🎧 Museum Audio Guide</strong>
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            document.querySelectorAll('.dropdown-content a').forEach(anchor => {
                anchor.addEventListener('click', function (e) {
                    ...
                    if (href.includes('#') && href.includes('seni_budaya.php')) {
